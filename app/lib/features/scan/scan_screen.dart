        ...
        builder: (ctx, setModal) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 14),
              TextField(controller: qty, autofocus: true, keyboardType: const TextInputType.numberWithOptions(decimal: true), inputFormatters: kCnNumber, decoration: const InputDecoration(labelText: '数量')),
