    ...
    builder: (ctx) => StatefulBuilder(
      builder: (ctx, setModal) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          TextField(controller: name, autofocus: existing == null, decoration: const InputDecoration(hintText: '客户名称 *')),
          const SizedBox(height: 10),
          TextField(controller: phone, decoration: const InputDecoration(hintText: '电话')),
          const SizedBox(height: 10),
          TextField(controller: address, decoration: const InputDecoration(hintText: '地址（送货用）')),
          const SizedBox(height: 10),
          TextField(controller: notes, decoration: const InputDecoration(hintText: '备注')),
          const SizedBox(height: 14),
